package com.pixapp.jiujitsuscoring;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void threePointButton(View view) {
        scoreTeamA = scoreTeamA + 3;
        displayForTeamA(scoreTeamA);
    }

    public void twoPointButton(View view) {
        scoreTeamA = scoreTeamA + 2;
        displayForTeamA(scoreTeamA);
    }

    public void fourPointButton(View view) {
    ...
    public void fourPointButtonB(View view) {
